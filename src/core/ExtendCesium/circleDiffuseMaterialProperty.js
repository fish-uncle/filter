 ...
 * map.viewer.entities.add({
	position: Cesium.Cartesian3.fromDegrees(120.611113, 27.7506),
	name: '扩散圆',
	ellipse: {
			semiMinorAxis: 200,
			semiMajorAxis: 200,
			material: new Cesium.CircleDiffuseMaterialProperty({
				color: Cesium.Color.fromCssColorString('#FF5900'),
				speed: 14,
			}),
		},
	})
...
export default class CircleDiffuseMaterialProperty {
	...
	getType(time) {
		return window.Cesium.Material.CircleDiffuseMaterialType
	}
